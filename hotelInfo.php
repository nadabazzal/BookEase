  ...
  <main>
    ...
    <section id="details">
      ...
      <div class="details-box">
        <div class="detail-item">📍 Downtown Beirut, Lebanon</div>
        <div class="detail-item rating-pill">9.3</div>
        <div class="detail-item">📞 +961 81/363443</div>
        <div class="detail-item">📧 legray@gmail.com</div>
